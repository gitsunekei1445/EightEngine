...
if __name__ == '__main__':
    ...
    render.set_numberModel(2)
    render.set_numberTexture(2)
    model = render.loaderModel('cudeTest.obj',1,0,0,0)
    modelTexture = render.loaderTexTure('uv.png',1)
    while not gui.gui_close:
        render.render_update()
        model.model_render(modelTexture.textures)
        gui.gui_update()
        gui.gui_Fps()
