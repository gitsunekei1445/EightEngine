...
class Rendering:
    ...
    def loaderModel(self,modelPath,numberModel,x,y,z):
        ...
        if self.numberModel < numberModel:
            ...
            model = Model(self.VAO[numberModel],self.VBO[numberModel],modelPath,numberModel,x,y,z)
            return model
    ...
    def loaderTexTure(self,texturePath,numberTexture):
        ...
        if self.numberTexture < numberTexture:
            ...
            texture = Texture(texturePath,self.texture[numberTexture])
            return texture
...
class Model:
    def __init__(self,VAO,VBO,modelPath,number,x=0,y=0,z=0):
        ...
        glVertexPointer(0,3,GL_FLOAT,GL_FALSE,self.model_buffer.itemsize*8,ctypes.c_void_p(0))
        # model texture
        glEnableVertexAttribArray(1)
        glVertexPointer(1,2,GL_FLOAT,GL_FALSE,self.model_buffer.itemsize*8,ctypes.c_void_p(12))
        # model normal vertices
        glEnableVertexAttribArray(2)
        glVertexPointer(2,3,GL_FLOAT,GL_FALSE,self.model_buffer.itemsize*8,ctypes.c_void_p(20))
